...
# Đường dẫn 
MODEL_PATH = "E:/Smart_Crib/yolov26_250e_1000pic_702010/content/runs/detect/train/weights/best.pt"
VIDEO_PATH = 0  
...
EAR_THRESHOLD_SLEEP = 0.3  # Mắt nhắm nhỏ hơn mức này -> NGỦ (nếu không khóc)
...
def main():
    ...
    while cap.isOpened():
        ...
        results = model(frame, stream=True, verbose=False, conf=0.5, iou=0.45)
